            ...
            <TableRow key={t.id}>
              ...
              <TableCell>
                <div className="flex items-center gap-1">
                  ...
                  {isAdmin && (
                    <>
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => { setSelected(t); setEditForm({
      ...
      <Modal open={createOpen} onClose={() => setCreateOpen(false)} title="Add New Teacher" maxWidth="max-w-xl">
        <div className="grid grid-cols-2 gap-4">
          <Field label="First Name">
            <Input value={form.first_name} onChange={e => setForm({ ...form, first_name: e.target.value })} placeholder="Ayesha" />
          </Field>
          <Field label="Last Name">
            <Input value={form.last_name} onChange={e => setForm({ ...form, last_name: e.target.value })} placeholder="Khan" />
          </Field>
          <Field label="Email">
            <Input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} placeholder="ayesha@school.edu" />
          </Field>
          <Field label="Phone">
          ...
          <Field label="Qualification">
            <Input value={form.qualification} onChange={e => setForm({ ...form, qualification: e.target.value })} placeholder="M.Sc. Mathematics" />
          </Field>
          ...
          <div className="col-span-2">
            <Field label="Address">
              <Textarea className="resize-none h-20" value={form.address} onChange={e => setForm({ ...form, address: e.target.value })} placeholder="House #10, Street 5, Lahore" />
            </Field>
          </div>
          <Field label="Status">
